...
DEFAULT INSTRUCTION SET : THUMB-1
DEFAULT ARCHITECTURE    : ARMv5TE
SUPPORTED ARM VERSIONS  : 5, 4
SUPPORTED THUMB VERSIONS: 2, 1
REFERENCES:
    0 - https://osmocom.org/projects/baseband/wiki/toolchain
    1 - https://www.intel.com/content/dam/support/us/en/programmable/support-resources/bulk-container/pdfs/literature/third-party/ddi0100e-arm-arm.pdf
    2 - https://developer.arm.com/documentation/dui0497/a/the-cortex-m0-instruction-set

Instructions marked with * - not supported in ARMv4T


> ARM instructions (number of variants)
...
> THUMB instructions (number of variants)
...
//retrieves n bits from x starting at bit b
#define BITS(x, b, n) ((x >> b) & ((1 << n) - 1))
//convert n-bit value to signed 32 bits
#define SIGNEX32_BITS(x, b, n) ((BITS(x,b,n) ^ (1<<(n-1))) - (1<<(n-1)))
#define SIGNEX32_VAL(x, n) ((x ^ (1<<(n-1))) - (1<<(n-1)))
//rotate right 32-bit value x by n bits
